...
import { Link } from 'react-router-dom'; // Para el botón de volver si lo necesitas

const AboutUsPage = () => {
  return (
    // Contenedor principal de la página, centrado y con padding
      ...
      <Row className="image-grid justify-content-center g-4 mb-5">
        ...
        <Col xs={12} sm={6} md={4} lg={3} className="d-flex justify-content-center">
          <div className="grid-item-image">
            {/* Reemplaza 'https://placehold.co/400x300/E0BBE4/FFFFFF?text=Equipo+1' con la URL de tu imagen */}
            <Image src="https://placehold.co/400x300/E0BBE4/FFFFFF?text=Equipo+1" alt="Miembro del equipo 1" fluid rounded />
        ...
        <Col xs={12} sm={6} md={4} lg={3} className="d-flex justify-content-center">
          <div className="grid-item-image">
            {/* Reemplaza 'https://placehold.co/400x300/957DAD/FFFFFF?text=Misión' con la URL de tu imagen */}
        ...
        <Col xs={12} sm={6} md={4} lg={3} className="d-flex justify-content-center">
          <div className="grid-item-image">
            {/* Reemplaza 'https://placehold.co/400x300/FFC72C/FFFFFF?text=Valores' con la URL de tu imagen */}
        ...
        <Col xs={12} sm={6} md={4} lg={3} className="d-flex justify-content-center">
          <div className="grid-item-image">
            {/* Reemplaza 'https://placehold.co/400x300/C3F8FF/FFFFFF?text=Visión' con la URL de tu imagen */}
